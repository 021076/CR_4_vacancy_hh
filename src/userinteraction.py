...
def user_interaction():
    ...
    print("Укажите пожалуйста параметры фильтрации для поиска вакансий")
    ...
    if only_with_salary:
        ...
        top_vacancies = input(f"- укажите количество ТОП - не более {in_top} или пропустите заполнение: ")
        print("------------------------------")
        # Вывод ТОП вакансий
        if top_vacancies:
